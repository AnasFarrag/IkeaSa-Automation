...
public class Assertions extends ElementActions{
    ...
    public void assertElementTextContent(By locator, String text) {
        String elementText;
        elementText = getElement(locator).getAttribute("textContent");
        assertEquals(elementText, text);
    }
...
//    public void assertAttributeValueContainsText(WebElement element, String attribute, String text) {
//        String attributeValue = element.getAttribute(attribute);
//        assertTrue(attributeValue.contains(text));
//    }
    //===================================Assert list size=====================================
